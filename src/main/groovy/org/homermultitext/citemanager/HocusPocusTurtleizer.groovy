...
class HocusPocusTurtleizer {
  ...
  HocusPocusTurtleizer(File inventoryFile,  File citeConfigFile, File archiveDir,  File workingDir, File outFile, boolean prefix) 
  throws Exception {
	...
	workingDir.mkdir()
      ...
      corpus = new Corpus(inventoryFile, citeConfigFile, archiveDir)
  ...
  public static void main(String[] args)  {
    ...
    try {
      ...
      outFile = new File(outputDir, args[4])
    ...
    default :
    throw new Exception ("HocusPocusTurteizer: main method needs 6 args" )
    break
    }
  ...
  void generateTtl() {
    this.corpus.turtleizeRepository(workDirectory, includePrefix)
  }
